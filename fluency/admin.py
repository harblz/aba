...
class FlashcardAdmin(admin.ModelAdmin):
    list_display = ('escaped_flashcard_text', 'flashcard_unit_name', 'flashcard_deck_name', 'has_answer', 'flashcard_difficulty', 'task_list_item', 'pub_date', 'was_published_recently')
    list_per_page = 100000
